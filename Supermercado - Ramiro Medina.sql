...
ADD CONSTRAINT FK_PRODUCTS_STORES FOREIGN KEY FK_PRODUCTS_STORES (id_store)
REFERENCES STORES (id_store),
ADD CONSTRAINT FK_PRODUCTS_ORDERS FOREIGN KEY FK_PRODUCTS_ORDERS (id_order)
REFERENCES ORDERS (id_order);

ALTER TABLE CLIENTS
ADD CONSTRAINT FK_CLIENTS_ORDERS FOREIGN KEY FK_CLIENTS_ORDERS (id_order)
REFERENCES ORDERS (id_order);

ALTER TABLE SUPPLIERS
ADD CONSTRAINT FK_SUPPLIERS_PRODUCTS FOREIGN KEY FK_SUPPLIERS_PRODUCTS (id_product)
...
ALTER TABLE STORES
ADD CONSTRAINT FK_STORES_EMPLOYEES FOREIGN KEY FK_STORES_EMPLOYEES (id_employee)
REFERENCES EMPLOYEES (id_employee),
ADD CONSTRAINT FK_STORES_PRODUCTS FOREIGN KEY FK_STORES_PRODUCTS (id_product)
REFERENCES PRODUCTS (id_product),
ADD CONSTRAINT FK_STORES_ORDERS FOREIGN KEY FK_STORES_ORDERS (id_order)
REFERENCES ORDERS (id_order);
